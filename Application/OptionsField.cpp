...
OptionsField::OptionsField(Window * window)
{
	...
	optionsWindowTypeActor = new OptionsWindowType(window);
	optionsWindowSizeActor = new OptionsWindowSize(window);
	optionsGraphicsActor = new OptionsGraphics();
	optionsVolumeActor = new OptionsVolume();
}

OptionsField::~OptionsField()
{
	SAFE_RELEASE(optionsWindowTypeActor);
	SAFE_RELEASE(optionsWindowSizeActor);
	SAFE_RELEASE(optionsGraphicsActor);
	SAFE_RELEASE(optionsVolumeActor);
}
